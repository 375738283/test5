...
var prefix = "/ad/advertisementShow"
$(function() {
	//时间框
  ...
  //	$(".form_datetime").val(formatDate(new Date()));
	...
	$("#beginDate").datetimepicker("setDate",start);
	$("#endDate").datetimepicker("setDate", new Date(new Date(new Date().toLocaleDateString()).getTime()+24*60*60*1000-1));
